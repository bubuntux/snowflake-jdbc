...
public class SnowflakeChunkDownloader implements ChunkDownloader {
  ...
  private final SnowflakeResultSetSerializableV1.StreamFetcher streamFetcher;
  ...
  public SnowflakeResultSetSerializableV1.StreamFetcher getStreamFetcher() {
  ...
  /**
   * Constructor to initialize downloader, which uses the default stream fetcher
   *
  ...
  public SnowflakeChunkDownloader(SnowflakeResultSetSerializableV1 resultSetSerializable)
    ...
    this.streamFetcher = resultSetSerializable.getStreamFetcher();
  ...
  private static Callable<Void> getDownloadChunkCallable(
    ...
    SnowflakeResultSetSerializableV1.ChunkDownloadContext downloadContext =
        new SnowflakeResultSetSerializableV1.ChunkDownloadContext(
            downloader,
            resultChunk,
            qrmk,
            chunkIndex,
    ...
    downloader.getStreamFetcher().setChunkDownloadContext(downloadContext);
    ...
    return new Callable<Void>() {
      ...
      public Void call() {
        ...
        try {
          ...
          InputStream is = downloader.getStreamFetcher().getInputStream();
          logger.debug(
